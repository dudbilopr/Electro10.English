...
def generate_report():
    ...
    # 4. Firebase Backend
    add_heading(doc, '4. Configuration del Backend en Firebase', 1)
    ...
    doc.add_paragraph('2. PWA (Progressive Web App): Agregar un archivo manifest.json y un Service Worker para que los Students puedan instalar Electro10 en sus celulares como una aplicación nativa y acceder offline a los Workshops.')
    ...
    output_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'Technical_Report_Electro10.docx')
