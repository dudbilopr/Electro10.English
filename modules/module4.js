...
export const module4 = {
    ...
    "lecciones": [
        { "id":"m4-l1","tipo":"multivideo","recurso":"mR1neFcFQms|UHPetewKgvc|D4_fOFVP5bI|gTjRqI6aFx8|DkD5JxYMjvU|eVt1V7G6W-I","titulo":"1. Videos — Electric Potential","descripcion":"Del Work eléctrico al Powerl: derivación completa con ejemplos.","xp":10 },
        ...
        { "id":"m4-l7","tipo":"ejercicio","recurso":"workshops/Workshop_4_Potential_Electrico.html","titulo":"5. Workshop Práctico — Electric Potential","descripcion":"Problemas de Energy Powerl, Powerl de distribuciones y equiPowerles.","xp":30 },
        ...
        { "id":"m4-e1","tipo":"referencias","titulo":"8. Referencias BiblioCharts","descripcion":"Fuentes académicas sobre Electric Potential y Energy en campos eléctricos.","xp":10,
          "secciones":[
            { "tituloSeccion":"📘 Libros de texto","links":[
                { "url":"https://openstax.org/books/university-physics-volume-2/pages/7-1-electric-potential-energy","titulo":"OpenStax: Energy Potential y Potential — Cap. 7","descripcion":"Development completo del Electric Potential con ejemplos." },
            ...
            { "tituloSeccion":"🌐 Resources web","links":[
                { "url":"https://www.fisicalab.com/apartado/Powerl-electrico","titulo":"Fisicalab: Electric Potential","descripcion":"Theory y ejercicios con Charts de equiPowerles." },
