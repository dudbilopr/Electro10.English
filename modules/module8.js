...
export const module8 = {
    ...
    "lecciones": [
        ...
        { "id":"m8-l2","tipo":"presentacion","recurso":"./player.html?clase=8","titulo":"2. Interactive Slides","descripcion":"Visualización 3D del campo magnético de distintas geometrías de conductor.","xp":15 },
        ...
        { "id":"m8-j1","tipo":"Game","recurso":"games/Game_8.html","titulo":"4. Physics Quest — Biot-Savart","descripcion":"¡Construye el electroimán perfecto! Elige geometría y Current para alcanzar el campo objective.","xp":25,"logro":{"id":"logro_m8","nombre":"Arquitecto Magnético","icono":"[MAGNET]"} },
        { "id":"m8-l7","tipo":"exercise","recurso":"workshops/Workshop_8_Biot_Savart.html","titulo":"5. Practical Workshop — Biot-Savart","descripcion":"Calculation del campo magnético de hilos, arcos, espiras y solenoides finitos.","xp":30 },
        { "id":"m8-q1","tipo":"quiz","recurso":"quizzes/Quiz_Adaptive_8.html","titulo":"6. Adaptive Quiz — Module 8","descripcion":"Evalúa desde la dirección de B hasta cálculos integrales de Biot-Savart.","xp":40 },
        ...
        { "id":"m8-e1","tipo":"referencias","titulo":"8. Bibliographic References","descripcion":"Fuentes sobre la Biot-Savart Law y campo magnético de Currents.","xp":10,
          "secciones":[
