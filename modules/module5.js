...
export const module5 = {
    ...
    "lecciones": [
        ...
        { "id":"m5-l2","tipo":"presentacion","recurso":"./player.html?clase=5","titulo":"2. Interactive Slides","descripcion":"Animaciones del proceso de carga de capacitores y efecto de los Dielectrics.","xp":15 },
        ...
        { "id":"m5-l7","tipo":"exercise","recurso":"workshops/Workshop_5_Capacitance.html","titulo":"5. Practical Workshop — Capacitance","descripcion":"Problemas de capacitores simples, combinaciones en red y Energy almacenada.","xp":30 },
        { "id":"m5-q1","tipo":"quiz","recurso":"quizzes/Quiz_Adaptive_5.html","titulo":"6. Adaptive Quiz — Module 5","descripcion":"Desde definición de Capacitance hasta cálculo de Energy con Dielectrics.","xp":40 },
        ...
        { "id":"m5-e1","tipo":"referencias","titulo":"8. Bibliographic References","descripcion":"Fuentes académicas sobre capacitores, Dielectrics y Energy en campos eléctricos.","xp":10,
          "secciones":[
