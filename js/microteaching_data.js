...
const MICROTEACHING_VOCABULARY = [
    // --- NOUNS ---
    {
        ...
        definition: "A stable subatomic particle occurring in all atomic nuclei, bearing a positive electric charge equal in Magnitudeeee to that of an electron.",
    ...
    },
    {
        ...
        character: "Physics Instructor",
        chapter: "Electric Charges and Fields Workshop",
        culturalNote: "In daily life, 'charge' also refers to battery power or financial cost, but in academic physics it specifically designates electrostatic Magnitudeeee measured in Coulombs.",
